...
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
RETURNING id, user_id, gender, region_id, map_id, x, z, hp, max_hp, speed, rotation_y, weapon_name, weapon_type, weapon_state
`
...
SELECT id, user_id, gender, region_id, map_id, x, z, hp, max_hp, speed, rotation_y, weapon_name, weapon_type, weapon_state FROM characters WHERE id = ?
`
...
SELECT id, user_id, gender, region_id, map_id, x, z, hp, max_hp, speed, rotation_y, weapon_name, weapon_type, weapon_state FROM characters WHERE user_id = ?
`
